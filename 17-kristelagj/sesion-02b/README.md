...
Por otro lado, se reconoce cada elemento que se nos entregó de manera visual, pero nombres y que hacen, no muy bien, entonces me dedique a revisar los apuntes de mis compañeros para poder encontrar nuevas cosas y hacer una guía de que es cada cosa agregando mis apuntes. Quiero encontrar una manera de hacer algún manual que yo entienda de lo que hemos visto y de cada pieza de este puzzle. 
...
**LEDs:** Es un diodo que emite luz cuando la electricidad pasa a través de él. Sirve como indicador visual (encendido/apagado) o para iluminación básica, consumiendo muy poca energía. Dienen un lado positivo ánodo (+) y cátodo (-)
...
**potenciómetros B100k:** Es una resistencia variable. Sirve para que tú puedas controlar manualmente la intensidad de algo, como subir el volumen de un parlante o variar el brillo de una luz LED al girar su perilla.
